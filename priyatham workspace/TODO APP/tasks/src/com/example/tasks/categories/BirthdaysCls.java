...
public class BirthdaysCls extends Fragment {
	...
	@Override
	   public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		  	rootView =inflater.inflate(R.layout.birthdays, container,false);
		  	rowItems = new ArrayList<RowItem>();
	        l1=(ListView)rootView.findViewById(R.id.listbirthdays);
	        ...
	        cu= db.rawQuery("select * from tasksdetails where category ='BIRTHDAYS' and priority ='HIGH'", null); // null is for mode.
	        ...
	        cu= db.rawQuery("select * from tasksdetails where category ='BIRTHDAYS' and priority ='NORMAL'", null); // null is for mode.
	        ...
	        cu= db.rawQuery("select * from tasksdetails where category ='BIRTHDAYS' and priority ='LOW'", null); // null is for mode.
