...
public class WeeklyCls extends Fragment {
	...
	@Override
	   public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		  	rootView =inflater.inflate(R.layout.weekly, container,false);
		  	rowItems = new ArrayList<RowItem>();
	        l1=(ListView)rootView.findViewById(R.id.listweekly);
	        ...
	        cu= db.rawQuery("select * from tasksdetails where category ='WEEKLY' and priority ='HIGH'", null); // null is for mode.
	        ...
	        cu= db.rawQuery("select * from tasksdetails where category ='WEEKLY' and priority ='NORMAL'", null); // null is for mode.
	        ...
	        cu= db.rawQuery("select * from tasksdetails where category ='WEEKLY' and priority ='LOW'", null); // null is for mode.
