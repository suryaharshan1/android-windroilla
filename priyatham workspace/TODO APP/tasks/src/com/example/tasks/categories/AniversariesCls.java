...
public class AniversariesCls extends Fragment {
	...
	@Override
	   public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		  	rootView =inflater.inflate(R.layout.aniversaries, container,false);
		  	rowItems = new ArrayList<RowItem>();
	        l1=(ListView)rootView.findViewById(R.id.listaniversries);
	        ...
	        cu= db.rawQuery("select * from tasksdetails where category ='ANIVERSARIES' and priority ='HIGH'", null); // null is for mode.
	        ...
	        cu= db.rawQuery("select * from tasksdetails where category ='ANIVERSARIES' and priority ='NORMAL'", null); // null is for mode.
	        ...
	        cu= db.rawQuery("select * from tasksdetails where category ='ANIVERSARIES' and priority ='LOW'", null); // null is for mode.
