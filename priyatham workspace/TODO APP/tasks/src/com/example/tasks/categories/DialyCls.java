...
public class DialyCls extends Fragment {
	...
	@Override
	   public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		  	rootView =inflater.inflate(R.layout.dialy, container,false);
		  	rowItems = new ArrayList<RowItem>();
	        l1=(ListView)rootView.findViewById(R.id.listdialy);
	        ...
	        cu= db.rawQuery("select * from tasksdetails where category ='DAILY' and priority ='HIGH'", null); // null is for mode.
	        ...
	        cu= db.rawQuery("select * from tasksdetails where category ='DAILY' and priority ='NORMAL'", null); // null is for mode.
	        ...
	        cu= db.rawQuery("select * from tasksdetails where category ='DAILY' and priority ='LOW'", null); // null is for mode.
